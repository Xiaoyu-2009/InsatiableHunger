...
public class FiveModel<T extends Gluttony> extends HierarchicalModel<T> {
	...
	public FiveModel(ModelPart root) {
		...
		this.Finger3 = this.Hand.getChild("Finger3");
		...
		this.Finger6 = this.Hand2.getChild("Finger6");
		this.bone14 = this.Finger6.getChild("bone14");
		this.Finger7 = this.Hand2.getChild("Finger7");
		this.bone15 = this.Finger7.getChild("bone15");
		this.Finger8 = this.Hand2.getChild("Finger8");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Backleg = Root.addOrReplaceChild("Backleg", CubeListBuilder.create(), PartPose.offset(-25.0F, -70.0F, 63.0F));
		...
		PartDefinition bone4 = Backleg.addOrReplaceChild("bone4", CubeListBuilder.create(), PartPose.offset(-11.0F, 26.0F, 9.0F));
		...
		PartDefinition bone5 = bone4.addOrReplaceChild("bone5", CubeListBuilder.create(), PartPose.offset(-1.0F, 15.0F, 13.0F));
		...
		PartDefinition Foot = bone5.addOrReplaceChild("Foot", CubeListBuilder.create().texOffs(656, 447).addBox(-15.0F, -2.0F, -10.0F, 21.0F, 13.0F, 23.0F, new CubeDeformation(0.0F)), PartPose.offset(6.0F, 23.0F, -11.0F));

		PartDefinition bone6 = Foot.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(682, 107).addBox(-4.0F, -5.0F, -19.0F, 7.0F, 10.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offset(-12.0F, 0.0F, -10.0F));
		...
		PartDefinition bone10 = Foot.addOrReplaceChild("bone10", CubeListBuilder.create().texOffs(682, 107).addBox(-4.0F, -5.0F, -19.0F, 7.0F, 10.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 0.0F, -10.0F));
		...
		PartDefinition bone11 = Foot.addOrReplaceChild("bone11", CubeListBuilder.create().texOffs(682, 107).addBox(-4.0F, -5.0F, -19.0F, 7.0F, 10.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 1.0F, -10.0F));
		...
		PartDefinition Body = Root.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(299, 0).addBox(0.0F, -51.0F, -57.0F, 0.0F, 32.0F, 83.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -72.0F, 72.0F));
		...
		.texOffs(227, 291).addBox(-16.0F, -22.0F, 2.0F, 32.0F, 38.0F, 65.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.0F, 14.0F));
		...
		.texOffs(227, 395).addBox(-12.0F, -19.0F, 0.0F, 24.0F, 31.0F, 60.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 67.0F));
		...
		.texOffs(422, 291).addBox(-9.0F, -15.0F, 0.0F, 18.0F, 22.0F, 55.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 60.0F));

		PartDefinition Tailtip = Tailbottom.addOrReplaceChild("Tailtip", CubeListBuilder.create().texOffs(0, 504).addBox(-5.0F, -7.0F, 0.0F, 10.0F, 15.0F, 55.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, 55.0F));

		PartDefinition bone7 = Tailtip.addOrReplaceChild("bone7", CubeListBuilder.create().texOffs(522, 578).addBox(-3.0F, -4.0F, 0.0F, 6.0F, 10.0F, 50.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 54.0F));

		PartDefinition Chest = Body.addOrReplaceChild("Chest", CubeListBuilder.create(), PartPose.offset(0.0F, -9.0F, -52.0F));
		...
		PartDefinition Neck = Chest.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 415).addBox(-17.0F, -19.0F, -32.0F, 34.0F, 45.0F, 43.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, -63.0F));
		...
		.texOffs(226, 591).addBox(-12.0F, 1.0F, -68.0F, 24.0F, 14.0F, 34.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 4.0F, -31.0F));
		...
		PartDefinition cube_r20 = Head.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(131, 572).mirror().addBox(-7.0573F, -27.1266F, 0.5708F, 0.0F, 36.0F, 47.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-7.0F, -14.0F, -2.0F, 0.2291F, -0.7716F, 0.6742F));

		PartDefinition cube_r21 = Head.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(131, 572).addBox(7.0573F, -27.1266F, 0.5708F, 0.0F, 36.0F, 47.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, -14.0F, -2.0F, 0.2291F, 0.7716F, -0.6742F));
		...
		.texOffs(478, 248).addBox(-13.0F, -20.0F, -17.0F, 26.0F, 20.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -2.0F));

		PartDefinition Arm = Chest.addOrReplaceChild("Arm", CubeListBuilder.create(), PartPose.offset(-36.0F, -5.0F, -30.0F));
		...
		PartDefinition bone = Arm.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(-58.0F, 31.0F, 6.0F));
		...
		PartDefinition Hand = bone.addOrReplaceChild("Hand", CubeListBuilder.create(), PartPose.offset(-9.0F, 48.0F, -37.0F));
		...
		PartDefinition Finger2 = Hand.addOrReplaceChild("Finger2", CubeListBuilder.create(), PartPose.offset(-7.0F, -1.0F, -29.0F));

		PartDefinition cube_r38 = Finger2.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(683, 63).addBox(-9.3149F, -5.7358F, -4.162F, 11.0F, 33.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.0F, 0.0F, -1.5423F, 0.1749F, 1.5423F));

		PartDefinition bone2 = Finger2.addOrReplaceChild("bone2", CubeListBuilder.create(), PartPose.offset(-1.0F, -10.0F, -28.0F));

		PartDefinition cube_r39 = bone2.addOrReplaceChild("cube_r39", CubeListBuilder.create().texOffs(227, 268).addBox(14.6851F, 7.2642F, -2.162F, 6.0F, 16.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 27.0F, 6.0F, -1.4889F, 1.2211F, 1.6144F));

		PartDefinition cube_r40 = bone2.addOrReplaceChild("cube_r40", CubeListBuilder.create().texOffs(299, 116).addBox(-6.7913F, -1.323F, -2.6026F, 29.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.0F, 0.0F, -1.5342F, 0.6983F, 1.5609F));

		PartDefinition Finger3 = Hand.addOrReplaceChild("Finger3", CubeListBuilder.create(), PartPose.offset(5.0F, -1.0F, -29.0F));

		PartDefinition cube_r41 = Finger3.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(683, 63).addBox(-9.3149F, -5.7358F, -5.162F, 11.0F, 33.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 0.0F, 0.0F, -1.5423F, 0.1749F, 1.5423F));

		PartDefinition bone8 = Finger3.addOrReplaceChild("bone8", CubeListBuilder.create(), PartPose.offset(-1.0F, -10.0F, -28.0F));

		PartDefinition cube_r42 = bone8.addOrReplaceChild("cube_r42", CubeListBuilder.create().texOffs(227, 268).addBox(14.6851F, 7.2642F, -2.162F, 6.0F, 16.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 27.0F, 6.0F, -1.4889F, 1.2211F, 1.6144F));

		PartDefinition cube_r43 = bone8.addOrReplaceChild("cube_r43", CubeListBuilder.create().texOffs(299, 116).addBox(-6.7913F, -1.323F, -2.6026F, 29.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 0.0F, 0.0F, -1.5342F, 0.6983F, 1.5609F));

		PartDefinition Finger = Hand.addOrReplaceChild("Finger", CubeListBuilder.create(), PartPose.offset(-15.0F, -1.0F, -25.0F));

		PartDefinition cube_r44 = Finger.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(682, 63).addBox(-7.3149F, -5.7358F, -4.162F, 12.0F, 33.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.0F, -4.0F, -1.5423F, 0.1749F, 1.5423F));

		PartDefinition bone3 = Finger.addOrReplaceChild("bone3", CubeListBuilder.create(), PartPose.offset(-1.0F, -7.0F, -28.0F));

		PartDefinition cube_r45 = bone3.addOrReplaceChild("cube_r45", CubeListBuilder.create().texOffs(422, 369).addBox(14.6851F, 8.2642F, -0.162F, 6.0F, 15.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 29.0F, 5.0F, -1.4102F, 1.3945F, 1.6955F));

		PartDefinition cube_r46 = bone3.addOrReplaceChild("cube_r46", CubeListBuilder.create().texOffs(370, 116).addBox(-4.4498F, -3.7523F, -2.5295F, 25.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5328F, 0.7419F, 1.5631F));

		PartDefinition Finger4 = Hand.addOrReplaceChild("Finger4", CubeListBuilder.create(), PartPose.offset(11.0F, -1.0F, -25.0F));
		...
		PartDefinition bone12 = Arm2.addOrReplaceChild("bone12", CubeListBuilder.create(), PartPose.offset(58.0F, 31.0F, 6.0F));
		...
		PartDefinition Hand2 = bone12.addOrReplaceChild("Hand2", CubeListBuilder.create(), PartPose.offset(9.0F, 48.0F, -37.0F));
		...
		PartDefinition Finger5 = Hand2.addOrReplaceChild("Finger5", CubeListBuilder.create(), PartPose.offset(7.0F, -1.0F, -29.0F));
		...
		PartDefinition Finger6 = Hand2.addOrReplaceChild("Finger6", CubeListBuilder.create(), PartPose.offset(-5.0F, -1.0F, -29.0F));
		...
		PartDefinition Finger7 = Hand2.addOrReplaceChild("Finger7", CubeListBuilder.create(), PartPose.offset(15.0F, -1.0F, -25.0F));
		...
		PartDefinition Finger8 = Hand2.addOrReplaceChild("Finger8", CubeListBuilder.create(), PartPose.offset(-11.0F, -1.0F, -25.0F));
		...
		PartDefinition Backleg2 = Root.addOrReplaceChild("Backleg2", CubeListBuilder.create(), PartPose.offset(25.0F, -70.0F, 63.0F));
		...
		PartDefinition bone17 = Backleg2.addOrReplaceChild("bone17", CubeListBuilder.create(), PartPose.offset(11.0F, 26.0F, 9.0F));
		...
		PartDefinition bone18 = bone17.addOrReplaceChild("bone18", CubeListBuilder.create(), PartPose.offset(1.0F, 15.0F, 13.0F));
		...
		PartDefinition Foot2 = bone18.addOrReplaceChild("Foot2", CubeListBuilder.create().texOffs(656, 447).mirror().addBox(-6.0F, -2.0F, -10.0F, 21.0F, 13.0F, 23.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-6.0F, 23.0F, -11.0F));

		PartDefinition bone19 = Foot2.addOrReplaceChild("bone19", CubeListBuilder.create().texOffs(682, 107).mirror().addBox(-3.0F, -5.0F, -19.0F, 7.0F, 10.0F, 19.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(12.0F, 0.0F, -10.0F));
		...
		PartDefinition bone20 = Foot2.addOrReplaceChild("bone20", CubeListBuilder.create().texOffs(682, 107).mirror().addBox(-3.0F, -5.0F, -19.0F, 7.0F, 10.0F, 19.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, 0.0F, -10.0F));
